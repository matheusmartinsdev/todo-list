...
<head>
    ...
    <title>TodoApp - seu lembrete diário</title>
    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    <a href="{{ url('/tarefas') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Minhas tarefas</a>
                @else
                    <a href="{{ route('login') }}"
            ...
            <div class="relative isolate pt-14">
                <div
                    ...
                    <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                        <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 dark:text-slate-400 sm:text-6xl">
                            Nunca mais perca um <span class="text-indigo-600">compromisso</span>
                        </h1>
                        <p class="mt-6 text-lg leading-8 text-gray-600">
                            Dizer que não se lembrou de um compromisso é coisa do passado.
                        </p>
                        <p class="text-lg leading-8 text-gray-600">
                            <span class="font-semibold text-gray-900 dark:text-indigo-600">TodoApp</span> é um aplicativo de tarefas para você nunca mais perder o que realmente importa</p>
                        <div class="mt-10 flex items-center justify-center lg:justify-start gap-x-6">
                            <a href="{{ route('register') }}"
                                class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Crie uma conta gratuita agora</span>
                            </a>
                        </div>
                    </div>
